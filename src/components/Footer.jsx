  ...
  return (
    <footer className="max-padd-container mb-4">
      <div className="max-padd-container bg-primary rounded-tr-3xl pt-12 xl:pt-20 pb-8">
        <h3 className="h3">Explorez les opportunités immobilières avec nous !</h3>
        <p>
        ...
        <div className="flex justify-between flex-wrap gap-x-4 gap-y-8">
          <div className="max-w-sm">
            ...
            <p className="py-4">
              Découvrez des propriétés d&apos;exception et des opportunités
              immobilières adaptées à vos besoins.
            </p>
            <div className="flexBetween pl-1 h-[3.3rem] bg-white w-full max-w-[366px] rounded-full ring-1 ring-slate-500/5">
              <input
                type="email"
      ...
      <p className="text-white bg-tertiary medium-14 py-2 px-8 rounded-br-3xl flexBetween">
        <span> 2025 CasaCentral.</span> Tous droits réservés.
      </p>
    </footer>
  );
}

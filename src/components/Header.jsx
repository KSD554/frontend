...
const Header = () => {
  ...
  return (
    <header className="max-padd-container fixed top-1 w-full left-0 right-0 z-50">
      ...
      >
        <div className="flexBetween py-3 space-x-1">
          {/* Logo */}
          <Link to={"/"}>
            <span className="font-[900] text-[22px]">
          ...
          {/* Button */}
          <div className="flexBetween gap-x-2 sm:gap-x-5 bold-16">
            {!menuOpened ? (
              <MdMenu
                onClick={toggleMenu}
            ...
            <button className="btn-secondary flexCenter gap-x-1 medium-16 rounded-full">

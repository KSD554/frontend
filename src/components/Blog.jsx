  ...
  return (
    <section className="max-padd-container">
      <div className="max-padd-container py-16 xl:py-28 rounded-3xl">
        ...
        <h2 className="h2">Les blogs de nos experts</h2>
          ...
          {BLOGS.map((blog) => (
            ...
            >
              ...
              <div className="absolute bottom-4 left-4 text-white text-[15px]">
                ...
                <h4 className="medium-18 pb-3 pt-1">{blog.category}</h4>
                <button className="bg-white rounded-xl font-semibold text-tertiary px-3 py-1">lire la suite</button>
              </div>
            </div>
          ))}
        </div>
